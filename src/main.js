...
//kosmos
const kosmosTexture = textureLoader.load('/textures/space.png')
...
//uran
const uranTexture = textureLoader.load('/textures/uran.jpg');
...
//neptun
const neptunTexture = textureLoader.load('/textures/neptun.jpg');
